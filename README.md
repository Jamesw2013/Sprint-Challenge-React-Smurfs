...
Client side routing does not refresh the page while server side routing does. client side routing does not refresh and it loads everything at once possibly making the load wait time faster for better user experience.
...
create = put or post ,  read = get, update = put delete = delete 

- [x] Mention three tools we can use to make AJAX requests.

get, put, post, delete, then() and catch()
